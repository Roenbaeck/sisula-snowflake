#!/usr/bin/env python3
"""FastAPI server for the Workflower webapp."""
...
def create_session() -> Session:
    ...
    config_path = next((path for path in paths if os.path.exists(path)), None)
    if not config_path:
    ...
    return Session.builder.configs(
        {
            ...
            "protocol": connection.get("protocol", "https"),
